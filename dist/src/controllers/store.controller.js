...
exports.submitCheckout = exports.getMyPurchasedCourses = exports.getStoreCourseById = exports.getStoreCourses = void 0;
...
// ─────────────────────────────────────────────────────────────────────────────
const getStoreCourses = async (req, res) => {
    try {
...
exports.getStoreCourses = getStoreCourses;
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
const getStoreCourseById = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.getStoreCourseById = getStoreCourseById;
// ─────────────────────────────────────────────────────────────────────────────
...
exports.getMyPurchasedCourses = getMyPurchasedCourses;
// ─────────────────────────────────────────────────────────────────────────────
